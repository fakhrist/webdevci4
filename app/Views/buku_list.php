...
<h1 class="h3 mb-4 text-gray-800">Daftar Data Buku</h1>
      ...
      <?php foreach ($list as $row) : ?>
        <tr>
          ...
          <td nowrap>
            ...
            <a href="<?= site_url('buku/delete/'.$row['id']) ?>" class="btn btn-danger" onclick="return confirm('Yakin bro?')"><i class="fas fa-trash"></i> Delete</a>
          </td>
        </tr>
      <?php endforeach ?>
    </tbody>
